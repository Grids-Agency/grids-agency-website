...
export default function Rays({
  ...
  const [[randomColor1RGB, randomColor2RGB]] = useState(() => {
  ...
  }, [color1RGB, color2RGB, intensity, rays, reach, position]);
...
void main() {
    ...
    // Match the color blend to the combined alpha. Adding both colors at full
    // strength overexposes overlapping rays against a light page background.
    vec3 blendedColor = premultColor1 + premultColor2 * (1.0 - alpha1);
