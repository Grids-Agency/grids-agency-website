      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col gap-32">
          ...
          {featuredProjects.map((project, index) => (
            <div
              key={project.id}
              className="group relative flex flex-col md:grid md:grid-cols-12 gap-8 md:gap-12 items-center"
            >
              {/* Project Number */}
              ...
              <div
                className={cn(
                  ...
                  index % 2 === 1
                    ? "md:order-first md:text-right items-end"
                    : "md:items-start",
                )}
              >
                <div
