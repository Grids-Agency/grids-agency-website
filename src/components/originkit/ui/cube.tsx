...
class RubikCubeScene {
  ...
  constructor(container: HTMLElement, cfg: Config) {
    ...
    this.canvas.className = "absolute inset-0 size-full cursor-grab touch-none";
...
export default function RubikParticles({
  ...
  const cfg = useMemo<Config>(() => ({
    ...
    sizePercent,
    dragSensitivity,
  }), [color, cubeGrid, dotsPerFace, dotSize, rotation, transition, sizePercent, dragSensitivity]);
